...
github.com/tjad/pgx/v4/stdlib to use pgx as a database/sql compatible driver.
...
mappings between Go and SQL. In addition, pgx uses the github.com/tjad/pgx/pgtype library to support more types. See
